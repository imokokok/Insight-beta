  ...
  public: {
    Tables: {
      ...
      slo_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: 'slo_metrics_slo_id_fkey';
            columns: ['slo_id'];
            isOneToOne: false;
      ...
      error_budgets: {
        Row: {
          ...
          projected_depletion: string | null;
          status: string;
          created_at: string;
          updated_at: string;
        };
        ...
        Relationships: [
          {
            foreignKeyName: 'error_budgets_slo_id_fkey';
            columns: ['slo_id'];
            isOneToOne: false;
            referencedRelation: 'slo_definitions';
            referencedColumns: ['id'];
...
// 常用表类型导出 - SLO
export type SloDefinition = Tables<'slo_definitions'>;
export type SloMetric = Tables<'slo_metrics'>;
export type ErrorBudget = Tables<'error_budgets'>;
