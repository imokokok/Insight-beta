...
export type DetectionStatus = 'detected' | 'investigating' | 'confirmed' | 'false_positive' | 'resolved';
...
export interface DetectionEvidence {
  type: 'price_spike' | 'volume_anomaly' | 'liquidity_drop' | 'transaction_pattern' | 'time_correlation';
  description: string;
