...
describe('Onboarding Component', () => {
  ...
  it('should navigate through steps', async () => {
    ...
    const developerRole = screen.getAllByText('Developer')[0] as HTMLElement;
    await userEvent.click(developerRole);
    ...
    const nextButton = screen.getAllByText(/Next/i)[0] as HTMLElement;
  ...
  it.skip('should complete onboarding', async () => {
    ...
    const completeButton = screen.getAllByText(/Complete/i)[0] as HTMLElement;
