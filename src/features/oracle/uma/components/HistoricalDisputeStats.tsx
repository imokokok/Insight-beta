  ...
  if (disputes.length === 0) {
    return (
      <div className="rounded-lg border border-border bg-card p-6">
        <h3 className="mb-2 text-lg font-semibold">历史争议统计</h3>
        <p className="mb-4 text-sm text-muted-foreground">争议解决趋势和成功率分析</p>
    ...
    <div className="rounded-lg border border-border bg-card p-6">
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg border border-border bg-muted/30 p-3">
          <div className="text-xs text-muted-foreground">总争议数</div>
      ...
      {votingPeriodStats && (
        <div className="mb-6 grid gap-3 sm:grid-cols-3">
          <div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-3">
            <div className="text-xs text-blue-500">平均投票周期</div>
            <div className="text-lg font-bold text-blue-600">{votingPeriodStats.avg}h</div>
          </div>
          <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-3">
            <div className="text-xs text-green-500">最短投票周期</div>
            <div className="text-lg font-bold text-green-600">{votingPeriodStats.min}h</div>
          </div>
          <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-3">
            <div className="text-xs text-red-500">最长投票周期</div>
            <div className="text-lg font-bold text-red-600">{votingPeriodStats.max}h</div>
          </div>
        </div>
      )}
