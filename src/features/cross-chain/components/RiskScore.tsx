    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className={cn('flex flex-col items-center p-3 rounded-full', config.bgColor)}>
          ...
          <div>
            ...
            <Progress 
              ...
              className={cn(
                ...
                overallScore >= 40 ? '[&>div]:bg-yellow-500' : '[&>div]:bg-red-500'
              )}
            />
          </div>
              ...
              <div key={index} className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-muted-foreground">权重: {(factor.weight * 100).toFixed(0)}%</span>
                    <span className={cn(
                      'font-medium',
