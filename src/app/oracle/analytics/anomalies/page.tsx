      ...
      <div className="space-y-4">
        ...
        {total === 0 && (
          <div className="text-muted-foreground py-8 text-center">
            <Brain className="mx-auto mb-2 h-12 w-12 text-purple-500" />
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">Higher values = less sensitive</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">Required for statistical significance</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">Historical data window</p>
        </div>

        <div className="flex items-center justify-between rounded-lg border p-3">
          <div>
            <span className="font-medium">Seasonal Decomposition</span>
            <p className="text-muted-foreground text-xs">Detect periodic patterns</p>
          </div>
        ...
        {config.useSeasonalDecomposition && (
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-xs">Period for seasonal pattern detection</p>
          </div>
        )}
      </CardContent>
    </Card>
