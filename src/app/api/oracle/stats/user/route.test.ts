...
describe('GET /api/oracle/stats/user', () => {
  ...
  it('returns user stats for valid address and caches result', async () => {
    ...
    const request = new Request(`http://localhost:3000/api/oracle/stats/user?address=${addr}`);
  ...
  it('rejects invalid address', async () => {
    const request = new Request('http://localhost:3000/api/oracle/stats/user?address=not-address');
