export const comparison = {
  ...
  latency: {
    ...
    highCorrelationDesc:
      'Strong correlation between latency and transaction count, possible network bottleneck',
  },
  cost: {
  ...
  deviation: {
    ...
    criticalWarningDesc:
      '{count} critical deviation events detected in the past, please be aware of the risks',
  },
  crossChain: {
  ...
  reliability: {
    ...
    scenario:
      'Compare the reliability performance of each protocol and select the most stable data source',
    showBreakdown: 'Show Score Details',
    ...
    scoringMethodDesc:
      'Overall score is calculated based on Accuracy (40%), Latency (30%), and Availability (30%)',
    weight: 'Weight',
    ...
    disclaimerDesc:
      'Scores are for reference only. Actual performance may vary due to market conditions, network congestion, and other factors',
    accuracy: 'Accuracy',
    latency: 'Latency',
