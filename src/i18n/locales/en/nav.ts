export const nav = {
  ...
  descriptions: {
    ...
    crossChain: 'Single oracle price difference analysis across different blockchain networks',
    explore: 'On-chain address lookup, trending data sources, and personalized recommendations',
