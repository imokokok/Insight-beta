export const nav = {
  ...
  descriptions: {
    ...
    chainlinkAnalysis: 'Industry-standard oracle - OCR rounds and node operator monitoring',
    pythAnalysis: 'Low-latency oracle - Publisher monitoring and price update analysis',
