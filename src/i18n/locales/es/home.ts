export const home = {
  ...
  actions: {
    ...
    comparison: {
      ...
      description: 'Análisis entre protocolos'
    }
  },
  trustIndicators: {
    protocols: '10+ Protocolos',
    chains: '15+ Cadenas',
    realTime: 'Datos en Tiempo Real'
  },
  stats: {
    supportedProtocols: 'Protocolos Soportados',
    priceFeeds: 'Fuentes de Precios',
  ...
  capabilities: {
    ...
    items: {
      priceComparison: {
        title: 'Comparación de Precios',
        description: 'Compara precios entre todos los principales protocolos oracle para detectar anomalías y garantizar la precisión de los datos.'
      },
      multiChain: {
      ...
      smartAlerts: {
        ...
        description: 'Recibe notificaciones de desviaciones de precios, datos obsoletos y problemas de protocolo en tiempo real.'
      },
      assertDispute: {
        title: 'Afirmar y Disputar',
        description: 'Rastrea afirmaciones, disputas y resoluciones entre protocolos oracle optimistas.'
      }
    }
  },
  protocols: {
