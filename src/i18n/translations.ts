  ...
  en: {
    ...
    oracle: {
      ...
      detail: {
        ...
        settleDesc:
          "This assertion has passed the challenge period and can be settled.",
  ...
  es: {
    ...
    oracle: {
      ...
      settleModal: {
        ...
        transactionNoteBody:
          "Esta transacción incluirá una nota personalizada.",
    ...
    watchlist: {
      emptyDesc:
        "Aún no has añadido ningún elemento a tu lista de seguimiento.",
    },
  },
  fr: {
    adminTokens: {
    ...
    oracle: {
      ...
      detail: {
        ...
        hash: "Hash",
        installWallet:
          "Veuillez installer MetaMask ou un autre portefeuille Web3.",
        marketQuestion: "Question de marché",
        reason: "Motif",
        ...
        settleDesc:
          "Cette assertion a passé la période de contestation et peut être réglée.",
      ...
      leaderboard: {
        ...
        topAssertersDesc:
          "Classement des assertionneurs par montant de caution verrouillé.",
        topDisputers: "Meilleurs contestataires",
        topDisputersDesc:
          "Classement des contestataires par montant de caution verrouillé.",
      },
      ...
      settleModal: {
        ...
        transactionNoteBody:
          "Cette transaction inclura une note personnalisée.",
  ...
  ko: {
    ...
    oracle: {
      ...
      config: {
        ...
        demo: "데모",
        demoHint:
          "데모 모드는 테스트 데이터를 사용하며 실제 체인에 연결되지 않습니다.",
        indexed: "인덱싱됨",
        indexedHint:
          "온체인 데이터에 연결되었습니다. 데이터가 자동으로 업데이트됩니다.",
        lagBlocks: "지연 (블록)",
        lastBlock: "마지막 블록",
        latestBlock: "최신 블록",
      ...
      detail: {
        ...
        settleDesc:
          "이 주장에 대한 이의 제기 기간이 종료되어 결제가 가능합니다.",
      ...
      disputeModal: {
        ...
        reasonExample:
          "예: 공식 데이터가 정반대 결과를 보여주고 소스가 수정되었습니다.",
