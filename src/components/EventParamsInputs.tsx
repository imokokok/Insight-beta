...
export function EventParamsInputs({
  rule,
  onPatchRuleParams,
  t,
}: EventParamsInputsProps) {
  switch (rule.event) {
    case "stale_sync":
      return (
        <div className="md:col-span-12">
          ...
          <Input
            ...
            value={Math.round(
              Number(
                (rule.params as { maxAgeMs?: unknown })?.maxAgeMs ??
                  5 * 60 * 1000,
              ) / 60_000,
            )}
            onChange={(e) => {
      ...
      return (
        <div className="md:col-span-12">
          ...
          <Input
            ...
            step={1}
            value={Number(
              (rule.params as { maxOpenAssertions?: unknown })
      ...
      return (
        <div className="md:col-span-12">
          ...
          <Input
            ...
            step={1}
            value={Number(
              (rule.params as { maxOpenDisputes?: unknown })?.maxOpenDisputes ??
                20,
            )}
            onChange={(e) => {
              const v = Math.max(1, Math.floor(Number(e.target.value)));
      ...
      return (
        <div className="md:col-span-12">
          ...
          <Input
            ...
            step={1}
            value={Number(
              (rule.params as { maxDelayMinutes?: unknown })?.maxDelayMinutes ??
                30,
            )}
            onChange={(e) => {
              const minutes = Math.max(1, Math.floor(Number(e.target.value)));
        ...
        <>
          <div className="md:col-span-6">
            ...
            <Input
              ...
              step={1}
              value={Number(
                (rule.params as { withinMinutes?: unknown })?.withinMinutes ??
                  60,
              )}
              onChange={(e) => {
                const minutes = Math.max(1, Math.floor(Number(e.target.value)));
          ...
          <div className="md:col-span-6">
            ...
            <Input
              ...
              step={1}
              value={Number(
                (rule.params as { minTotalVotes?: unknown })?.minTotalVotes ??
                  1,
              )}
              onChange={(e) => {
        ...
        <>
          ...
          <div className="md:col-span-4">
            ...
            <Input
              ...
              step={1}
              value={Number(
                (rule.params as { maxMarginPercent?: unknown })
                  ?.maxMarginPercent ?? 5,
              )}
              onChange={(e) => {
                const v = Math.max(
                  1,
                  Math.min(100, Math.floor(Number(e.target.value))),
                );
        ...
        <>
          <div className="md:col-span-4">
            ...
            <Input
              ...
              step={1}
              value={Number(
                (rule.params as { windowDays?: unknown })?.windowDays ?? 7,
              )}
              onChange={(e) => {
                const v = Math.max(1, Math.floor(Number(e.target.value)));
          ...
          <div className="md:col-span-4">
            ...
            <Input
              ...
              step={1}
              value={Number(
                (rule.params as { minAssertions?: unknown })?.minAssertions ??
                  20,
              )}
              onChange={(e) => {
                const v = Math.max(1, Math.floor(Number(e.target.value)));
      ...
      return (
        <div className="md:col-span-12">
          ...
          <Input
            ...
            step={50}
            value={Number(
              (rule.params as { thresholdMs?: unknown })?.thresholdMs ?? 1000,
            )}
            onChange={(e) => {
        ...
        <>
          ...
          <div className="md:col-span-6">
            ...
            <Input
              ...
              step={1}
              value={Number(
                (rule.params as { windowMinutes?: unknown })?.windowMinutes ??
                  5,
              )}
              onChange={(e) => {
                const v = Math.max(1, Math.floor(Number(e.target.value)));
      ...
      return (
        <div className="md:col-span-12">
          ...
          <Input
            ...
            step={10}
            value={Number(
              (rule.params as { thresholdMs?: unknown })?.thresholdMs ?? 200,
            )}
            onChange={(e) => {
