    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          hover && 'hover:border-purple-300 hover:bg-white/90 hover:shadow-xl hover:shadow-purple-500/10',
...
function ExpandableCard({ title, children, defaultExpanded = false, className }: ExpandableCardProps) {
...
export { CardEnhanced, InteractiveStatCard, ExpandableCard };
