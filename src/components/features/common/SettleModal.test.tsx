...
describe('SettleModal', () => {
  ...
  it('should render the modal when isOpen is true', () => {
    render(<SettleModal assertionId="0xassertion123" isOpen={true} onClose={mockOnClose} />);
  ...
  it('should not render the modal when isOpen is false', () => {
    const { container } = render(
      <SettleModal assertionId="0xassertion123" isOpen={false} onClose={mockOnClose} />,
    );
  ...
  it('should allow selecting outcome true', () => {
    ...
    expect(trueButton.closest('button')).toHaveClass('border-green-500 bg-green-50');
  });
  ...
  it('should allow selecting outcome false', () => {
    ...
    // Check if the button is selected (has correct class)
    expect(falseButton.closest('button')).toHaveClass('border-red-500 bg-red-50');
  });
