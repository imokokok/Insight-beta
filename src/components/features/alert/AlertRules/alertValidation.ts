...
> = {
  backlog_assertions: (rule, t) => {
    const maxOpenAssertions = getNumberParam(
      rule.params ?? {},
      "maxOpenAssertions",
    );
  ...
  backlog_disputes: (rule, t) => {
    const maxOpenDisputes = getNumberParam(
      rule.params ?? {},
      "maxOpenDisputes",
    );
  ...
  execution_delayed: (rule, t) => {
    const maxDelayMinutes = getNumberParam(
      rule.params ?? {},
      "maxDelayMinutes",
    );
  ...
  high_dispute_rate: (rule, t) => {
    ...
    const thresholdPercent = getNumberParam(
      rule.params ?? {},
      "thresholdPercent",
    );
  ...
  high_vote_divergence: (rule, t) => {
    ...
    const maxMarginPercent = getNumberParam(
      rule.params ?? {},
      "maxMarginPercent",
    );
