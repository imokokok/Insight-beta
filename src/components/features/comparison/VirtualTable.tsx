        ...
        >
          ...
          >
            <div className="flex h-full items-center px-4 text-sm font-medium">
              ...
              <div className="w-[80px] text-center">{t('comparison.table.status')}</div>
              <div className="w-[80px] text-right">{t('comparison.table.confidence')}</div>
