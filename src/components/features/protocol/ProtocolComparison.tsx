...
import { BarChart3, CheckCircle2, ChevronDown, ChevronUp, Scale, Trophy } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">
                              {protocol.activeFeeds} {t('protocol:comparison.feeds')} ·{' '}
                              {protocol.supportedChains} {t('protocol:comparison.chains')}
                            </div>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          <Progress value={protocol.healthScore} className="h-1.5 w-20" />
                        </div>
                      </TableCell>
                      <TableCell>
                        <span
                          className={cn(
                            'font-medium',
                            protocol.latency < 500
                              ? 'text-emerald-600'
                              : protocol.latency < 2000
                                ? 'text-blue-600'
                                : 'text-amber-600',
                          )}
                        >
                      ...
                      <TableCell>
                        <span
                          className={cn(
                            'font-medium',
                            protocol.accuracy >= 99
                              ? 'text-emerald-600'
                              : protocol.accuracy >= 95
                                ? 'text-blue-600'
                                : 'text-amber-600',
                          )}
                        >
                        ...
                        <TableCell colSpan={6} className="p-4">
                          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            {protocol.marketShare && (
                              <div className="space-y-1">
                                <span className="text-xs text-muted-foreground">
                                  {t('protocol:comparison.marketShare')}
                                </span>
                                <p className="text-lg font-semibold">
                            ...
                            <div className="space-y-1 sm:col-span-2">
                              <span className="text-xs text-muted-foreground">
                                {t('protocol:comparison.features')}
                              </span>
