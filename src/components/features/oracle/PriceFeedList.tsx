    ...
    <Card className={cn('overflow-hidden', className)}>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <div className="flex items-center gap-2">
          <CardTitle className="text-lg font-semibold">Live Price Feeds</CardTitle>
        ...
        <ScrollArea className="h-[400px]">
          <div className="divide-y">
            {Object.entries(groupedFeeds).map(([protocol, protocolFeeds]) => (
              <div key={protocol} className="p-4">
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {feed.isStale && <AlertCircle className="h-3.5 w-3.5 text-yellow-500" />}
          </div>
      ...
      <div className="text-right">
        <div className="font-mono font-medium">{formatPrice(feed.price, feed.decimals)}</div>
        <div
          className={cn(
