    ...
    return (
      <div className="relative w-full overflow-hidden rounded-3xl border border-white/60 bg-white/40 p-1 shadow-2xl shadow-purple-500/5">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 lg:p-8">
          {/* TVS Skeleton */}
          <div className="lg:col-span-5 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-gray-100/50 pb-6 lg:pb-0 lg:pr-8 space-y-6">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-6 lg:pl-2">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="p-5 rounded-2xl bg-white/20 border border-white/30 space-y-4"
              >
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-3xl glass-panel border border-white/60 p-1 shadow-2xl shadow-purple-500/5 group">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40 transition-opacity duration-700 group-hover:opacity-50">
        <div
          className="absolute -left-[10%] -top-[50%] h-[200%] w-[50%] bg-gradient-to-br from-purple-200/40 via-fuchsia-100/20 to-transparent blur-3xl rounded-full animate-pulse"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute right-0 bottom-0 h-[80%] w-[30%] bg-gradient-to-tl from-indigo-200/40 via-purple-100/20 to-transparent blur-3xl rounded-full animate-pulse"
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-6 lg:pl-2">
          ...
          <div className="relative group/card p-5 rounded-2xl bg-white/40 border border-white/50 hover:bg-white/80 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10 hover:-translate-y-1">
            <div className="flex items-center justify-between mb-4">
              ...
              <ArrowUpRight
                size={16}
                className="text-emerald-500 opacity-50 group-hover/card:opacity-100 transition-opacity"
              />
            </div>
            <div className="space-y-1.5">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wide">
