...
const RankItem = memo(function RankItem({
  ...
  return (
    ...
    >
      <div className="glass-panel group flex items-center justify-between rounded-xl border border-white/40 p-3 transition-all hover:-translate-y-0.5 hover:bg-white/60 hover:shadow-md">
    ...
    <div className="mx-auto w-full max-w-4xl">
      ...
      >
        ...
        <div className="relative z-10 mb-8 flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex items-center gap-1 rounded-xl border border-gray-200/50 bg-gray-100/50 p-1 backdrop-blur-sm">
            <button
