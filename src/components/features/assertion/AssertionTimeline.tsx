...
export function AssertionTimeline({
  ...
  const steps = useMemo(() => {
    ...
    stepsList.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
  ...
  return (
    <div className="relative pl-4">
      <div className="absolute bottom-10 left-10 top-10 w-0.5 bg-gradient-to-b from-purple-200/50 via-indigo-200/50 to-transparent" />
