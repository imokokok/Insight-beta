...
const defaultShortcuts: KeyboardShortcut[] = [
  ...
  { key: "o", shift: true, action: "navigate_oracle", description: "Go to Oracle" },
  { key: "d", shift: true, action: "navigate_disputes", description: "Go to Disputes" },
  { key: "a", shift: true, action: "navigate_alerts", description: "Go to Alerts" },
  { key: "u", shift: true, action: "navigate_audit", description: "Go to Audit Log" },
  { key: "w", shift: true, action: "navigate_watchlist", description: "Go to Watchlist" },
  { key: "m", shift: true, action: "navigate_my_assertions", description: "Go to My Assertions" },
  { key: "s", shift: true, action: "navigate_my_disputes", description: "Go to My Disputes" },
  { key: "k", ctrl: true, action: "toggle_search", description: "Toggle Search" },
  ...
  { key: "ArrowRight", alt: true, action: "go_forward", description: "Go Forward" },
  { key: "Home", ctrl: true, action: "scroll_top", description: "Scroll to Top" },
  { key: "End", ctrl: true, action: "scroll_bottom", description: "Scroll to Bottom" },
  { key: "?", shift: true, action: "show_shortcuts", description: "Show Shortcuts" },
];
...
export function KeyboardShortcutsHelp({ show, onClose, shortcuts = defaultShortcuts }: KeyboardShortcutsHelpProps) {
  const { t } = useI18n();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-dark-700">
          ...
          <button onClick={onClose} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-dark-700 transition-colors">
              ...
              <div className="space-y-2">
                {categoryShortcuts.map((shortcut, index) => (
                  <div key={index} className="flex items-center justify-between py-2">
                    <span className="text-sm text-gray-700 dark:text-dark-200">{shortcut.description}</span>
...
export function KeyboardShortcutIndicator({ className }: KeyboardShortcutIndicatorProps) {
  const { t } = useI18n();
    ...
    <>
      <button
        ...
        className={cn(
          ...
          "text-sm text-gray-600 dark:text-dark-400",
      ...
      >
        ...
        <kbd className="hidden sm:inline-block px-2 py-0.5 text-xs font-medium bg-gray-200 dark:bg-dark-600 rounded">
          ?
        </kbd>
      </button>
