...
export function ProfessionalLineChart({
  ...
  return (
    <div className={cn('rounded-2xl border border-primary/10 bg-white p-6', className)}>
      {(title || subtitle) && (
        <div className="mb-4">
            ...
            content={({ active, payload, label }) => {
              ...
              return (
                <div className="rounded-lg border border-primary/10 bg-white p-3 shadow-lg">
                  <p className="mb-1 text-xs text-gray-500">{timeFormatter(label)}</p>
        ...
        <div className="min-w-max">
          ...
          {yLabels.map((yLabel) => (
            <div key={yLabel} className="flex">
              <div className="flex w-32 flex-shrink-0 items-center px-2 py-3 text-sm font-medium text-gray-700">
                {yLabel}
              </div>
              {xLabels.map((xLabel) => {
                ...
                return (
                  <div key={`${xLabel}-${yLabel}`} className="w-24 flex-shrink-0 p-1">
                    <div
                      className="h-full cursor-pointer rounded-lg px-2 py-3 text-center transition-all hover:scale-105"
