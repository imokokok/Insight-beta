  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient':
          'radial-gradient(at 40% 20%, hsla(28,100%,74%,0) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189,100%,56%,0) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(340,100%,76%,0) 0px, transparent 50%)',
      },
      animation: {
